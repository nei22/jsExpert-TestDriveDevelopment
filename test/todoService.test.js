...
const TodoSevice = require('../src/todoService')
...
describe('todoService', () => {
    ...
    describe('#list', () => {
        const mockDatabase = [
            {
                name: 'XuxaDaSilva',
                age: 100,
                meta: { revision: 0, created: 1651201267252, version: 0 },
                '$loki': 1
            },
        ]
        let todoService
        beforeEach(() => {
            ...
            todoService = new TodoSevice(dependencies)
        })
    ...
    describe('#create', () => {
        ...
        it('should save todo item with late status when property is further than today', () => {
            const properties = {
                text: 'I must walk to my dog',
                when: new Date("2022-05-30 12:00:00 GMT-0")
        ...
        it('should save todo item with pending status', () => {
            const properties = {
                text: 'I must walk to my dog',
                when: new Date("2022-06-30 12:00:00 GMT-0")
